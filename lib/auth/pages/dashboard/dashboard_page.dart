...
import 'package:help_desk_flutter/auth/pages/tickets/create_ticket_page.dart';
import 'package:help_desk_flutter/auth/pages/tickets/ticket_detail_page.dart';
import 'package:help_desk_flutter/service/ticket_service.dart';

Color getActivityDotColor(String action) {
  switch (action.toUpperCase()) {
    case "CREATED":   return Colors.green;
    case "ASSIGNED":  return Colors.blue;
    case "UPDATED":   return Colors.purple;
    case "RESOLVED":  return Colors.green;
    case "CLOSED":    return Colors.orange;
...
IconData getActivityIcon(String action) {
  switch (action.toUpperCase()) {
    ...
    case "ESCALATED": return Icons.warning;
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  int get resolvedTickets => tickets.where((e) => e["status"] == "RESOLVED").length;
                  ...
                  return InkWell(
                    ...
                    onTap: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => TicketDetailPage(ticketId: ticket["ticketId"]),
                        ),
                      );
                      loadTickets();
                    },
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: LinearProgressIndicator(
                                    value: ticket["slaBreached"] == true ? 1 : 0.4,
                                  ),
                                ),
                              ],
                            ),
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final performedBy = log["performedBy"]?["fullName"] ?? "Unknown";
                            ...
                            return ListTile(
                              ...
                              leading: CircleAvatar(
                                ...
                                child: Icon(getActivityIcon(action),
                                    color: Colors.white, size: 18),
                              ),
                              title: Text("$title — Ticket #$entityId",
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(name,
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold, fontSize: 14)),
                                      Text("$activeTickets active tickets",
                                          style: const TextStyle(
