...
class _TicketListPageState extends State<TicketListPage> {
  ...
  Future<void> fetchTickets() async {
    ...
    try {
      ...
      tickets = response.map<Ticket>((e) => Ticket.fromJson(e)).toList();
  ...
  void filterTickets(String value) {
    ...
    setState(() {
      filteredTickets = tickets.where((t) {
        return t.ticketNo.toLowerCase().contains(term) ||
            t.subject.toLowerCase().contains(term) ||
  ...
  bool isOverdue(Ticket ticket) {
    ...
    return DateTime.parse(ticket.slaDueAt!).isBefore(DateTime.now());
  }
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Search by ticket no, subject or description',
